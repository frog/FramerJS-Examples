...
#compsSelection .compsTable .th .textInput{
    width: 100%;
}
...
#compsSelection .compsTable thead tr{
    height: 30px;
}
...
#compsSelection .compsTable .th.standalone{
    width: 90px;
}

#compsSelection .compsTable .th.standalone span{
    display: inline-block;
    margin: 2px;
}

#compsSelection .compsTable .th.standalone span.question{
    border-radius: 50%;
    background-color: #EAD3A8;
    color: #484043;
    width: 16px;
...
#compsSelection .compsTable .th.glyphs{
    width: 50px;
}
...
#compsSelection .compsTable .td .hideExtra.standalone{
    padding: 0;
}

#compsSelection .compsTable .td .hideExtra.glyphs{
    padding: 0;
    text-align: center;
}
